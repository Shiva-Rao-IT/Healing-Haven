...
const Footer = (props) => {
  ...
  const generateLink = (defaultPath) => {
    if (isUserRoute) {
      // If on a /user route, convert to /user/<something>
      const option = defaultPath.replace("/", ""); // e.g., "service" becomes "service"
      return `/user/${option}`;
    }
    return defaultPath;
  };
          ...
          <div className="footer-links">
            <div className="footer-column1">
              ...
              <div className="footer-footer-links1">
                <a href={generateLink("/")} className="thq-body-small">
                  Home
                </a>
                <a href={generateLink("/service")} className="thq-body-small">
                  Services
                </a>
                <a href={generateLink("/about")} className="thq-body-small">
                  About Us
                </a>
                <a href={generateLink("/blog")} className="thq-body-small">
                  Blog
                </a>
                <a href="/user/appoint" class="thq-body-small">Appointments</a>
              </div>
            </div>
...
Footer.defaultProps = {
  ...
  link7: "Terms of Use",
  link5: "FAQs",
  link8: "Book Appointment",
  action1: "Subscribe to our newsletter",
  content3: "&copy; 2025 Healing Haven. All rights reserved.",
  link4: "Blog",
  logoSrc: process.env.PUBLIC_URL + "/img/logo.png",
  cookiesLink: "/cookie-policy",
  content2: "Stay connected with us for the latest updates and news.",
  link9: "Testimonials",
  link6: "Privacy Policy",
  logoAlt: "Healing Haven Logo",
  link1: "Home",
