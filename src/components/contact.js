...
Contact.defaultProps = {
  content2:
    'Feel free to send us an email or give us a call. Our team will get back to you as soon as possible.',
  email1: 'contact@healinghaven.com',
  address1: '123 Therapy Way, Rohini, Delhi, 12345',
  content3:
    'For in-person visits, our office is conveniently located in the heart of the city. Book an appointment and come see us.',
  content1:
    'We are here to help. Reach out to us for any inquiries or to schedule an appointment.',
  content4: 'Connect with us on social media for updates, tips, and more.',
  heading1: 'Contact Us',
  content5: 'We look forward to hearing from you!',
  phone1: '+91 5551234567',
}
